...
const Cadastro: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#09090B] flex">
      ...
      <div className="flex-1 bg-[#09090B] flex flex-col items-center justify-center p-8">
        <img 
          src="/imgs/pinguim.png" 
          alt="Pinguim Lavras Eats" 
          className="w-32 h-32 rounded-full object-cover"
        />
        <h2 className="text-white text-4xl font-bold mb-2">Lavras Eats</h2>
        <p className="text-gray-300 text-xl">Seu site de avaliações de restaurantes!</p>
      </div>
    </div>
  )
}
